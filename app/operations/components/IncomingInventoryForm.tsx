...
export function IncomingInventoryForm() {
  ...
  const handleInputChange = (field: string, value: string | number) => {
    ...
    if (field === 'name') {
      ...
      validateQuantity(qty, 'masuk', formData.name)
    }
  }
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold tracking-tight">Barang Masuk</CardTitle>
        </CardHeader>
        <CardContent>
